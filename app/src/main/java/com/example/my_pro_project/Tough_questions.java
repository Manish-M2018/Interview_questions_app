...
public class Tough_questions extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        index = 0;
        tvquestions.setText(tough_questions[index]);
        tvanswers.setText("Press A button for answer");
        ...
        answer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tvanswers.setText(tough_answers[index]);
            }
        });
        ...
        //Text to speech object initialisation
